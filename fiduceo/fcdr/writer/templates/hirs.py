...
class HIRS:
    ...
    def add_common_sensor_variables(dataset, height):
        ...
        # scnlintime
        variable = HIRS._create_int32_vector(height, standard_name="time", long_name="Scan line time of day",
                                             orig_name="hrs_scnlintime")
    ...
    def add_common_angles(dataset, height):
        ...
        dataset["solar_zenith_angle"] = HIRS._create_geo_angle_variable("solar_zenith_angle", height,
                                                                        orig_name="solar_zenith_angle")
    ...
    def add_full_fcdr_variables(dataset, height):
        # c_earth
        default_array = DefaultData.create_default_array_3d(SWATH_WIDTH, height, NUM_RAD_CHANNELS, np.uint16,
        ...
        # L_earth
        default_array = DefaultData.create_default_array_3d(SWATH_WIDTH, height, NUM_RAD_CHANNELS, np.float32, np.NaN,
                                                            ["rad_channel", "y", "x"])
        variable = Variable(["rad_channel", "y", "x"], default_array)
        ...
        # u_c_earth
        default_array = DefaultData.create_default_array(NUM_CALIBRATION_CYCLE, NUM_CHANNELS, np.uint16,
        ...
        # S_bt
        variable = tu.create_float_variable(NUM_RAD_CHANNELS, NUM_RAD_CHANNELS, "covariance_brightness_temperature",
                                            dim_names=["rad_channel", "rad_channel"])
        tu.add_encoding(variable, np.uint16, DefaultData.get_default_fill_value(np.uint16), 0.01)
        ...
        # navigation_status
        variable = HIRS._create_int32_vector(height, standard_name="status_flag",
                                             long_name="Navigation status bit field", orig_name="hrs_navstat")
        dataset["navigation_status"] = variable

        # quality_flags
        variable = HIRS._create_int32_vector(height, standard_name="status_flag",
                                             long_name="Quality indicator bit field", orig_name="hrs_qualind")
        ...
        # scan_angles
        default_array = DefaultData.create_default_array(NUM_SCAN_ANGLES, height, np.float32,
                                                         dims_names=["y", "num_scan_angles"], fill_value=np.NaN)
        ...
        dataset["l1b_scanline_number"] = HIRS._create_int16_vector(height, long_name="scanline number",
        ...
        dataset["u_Tc_icct"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                             "uncertainty_temperature_internal_cold_calibration_target_counts")
        dataset["u_Tc_iwct"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                             "uncertainty_temperature_internal_warm_calibration_target_counts")
        dataset["u_Tc_patch_exp"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                  "uncertainty_temperature_patch_expanded_scale_counts")
        dataset["u_Tc_patch_full"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                   "uncertainty_temperature_patch_full_range_counts")
        dataset["u_Tc_tlscp_prim"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                   "uncertainty_temperature_telescope_primary_counts")
        dataset["u_Tc_tlscp_sec"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                  "uncertainty_temperature_telescope_secondary_counts")
        dataset["u_Tc_tlscp_tert"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                   "uncertainty_temperature_telescope_tertiary_counts")
        dataset["u_Tc_scanmirror"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                   "uncertainty_temperature_scanmirror_counts")
        dataset["u_Tc_scanmotor"] = HIRS._create_counts_uncertainty_vector_uint32(height,
                                                                                  "uncertainty_temperature_scanmotor_counts")

        dataset["u_solar_zenith_angle"] = HIRS._create_geo_angle_uncertainty_variable("uncertainty_solar_zenith_angle",
                                                                                      height, FILL_VALUE)
        dataset["u_solar_azimuth_angle"] = HIRS._create_geo_angle_uncertainty_variable(
            "uncertainty_solar_azimuth_angle", height, FILL_VALUE)
        dataset["u_satellite_zenith_angle"] = HIRS._create_geo_angle_uncertainty_variable(
            "uncertainty_satellite_zenith_angle", height, FILL_VALUE)
        dataset["u_satellite_azimuth_angle"] = HIRS._create_geo_angle_uncertainty_variable(
            "uncertainty_local_azimuth_angle", height, FILL_VALUE)
        ...
        dataset["temp_corr_slope"] = tu.create_scalar_float_variable("Slope for effective temperature correction",
                                                                     units="1")
        dataset["temp_corr_offset"] = tu.create_scalar_float_variable("Offset for effective temperature correction",
                                                                      units="1")
    ...
    def _create_temperature_array_3d(height, long_name, orig_name, dim_names):
        default_array = DefaultData.create_default_array_3d(PRT_READING, height, PRT_NUMBER, np.float32,
                                                            fill_value=np.NaN, dims_names=dim_names)
    ...
    def _create_scaled_int16_vector(height, standard_name=None, original_name=None, long_name=None, scale_factor=0.01):
        ...
        if original_name is not None:
            variable.attrs["orig_name"] = original_name
    ...
    @staticmethod
    def _create_scaled_uint16_vector(height, standard_name=None, original_name=None, long_name=None, scale_factor=0.01):
        default_array = DefaultData.create_default_vector(height, np.float32)
        variable = Variable(["y"], default_array)

...
class MVIRITest(unittest.TestCase):
    ...
    def test_add_full_fcdr_variables(self):
        ...
        self.assertEqual("rectangle", u_a0.attrs["scan_correlation_form"])
        self.assertEqual("pixel", u_a0.attrs["scan_correlation_units"])
        self.assertEqual([-np.inf, np.inf], u_a0.attrs["scan_correlation_scales"])
        self.assertEqual("rectangle", u_a0.attrs["time_correlation_form"])
        self.assertEqual("line", u_a0.attrs["time_correlation_units"])
        self.assertEqual([-np.inf, np.inf], u_a0.attrs["time_correlation_scales"])
        self.assertEqual("triangle", u_a0.attrs["image_correlation_form"])
        self.assertEqual("months", u_a0.attrs["image_correlation_units"])
        ...
        self.assertEqual("rectangle", u_a1.attrs["scan_correlation_form"])
        self.assertEqual("pixel", u_a1.attrs["scan_correlation_units"])
        self.assertEqual([-np.inf, np.inf], u_a1.attrs["scan_correlation_scales"])
        self.assertEqual("rectangle", u_a1.attrs["time_correlation_form"])
        self.assertEqual("line", u_a1.attrs["time_correlation_units"])
        self.assertEqual([-np.inf, np.inf], u_a1.attrs["time_correlation_scales"])
        self.assertEqual("triangle", u_a1.attrs["image_correlation_form"])
        self.assertEqual("months", u_a1.attrs["image_correlation_units"])
        self.assertEqual([-1.5, 1.5], u_a1.attrs["image_correlation_scales"])
        self.assertEqual("gaussian", u_a1.attrs["pdf_shape"])

...
class MVIRITest(unittest.TestCase):
    ...
    def test_add_full_fcdr_variables(self):
        ...
        self.assertEqual(np.int16(65535), u_toa_refl_vis.data[6, 110])
        ...
        self.assertEqual("true", u_toa_refl_vis.attrs["_Unsigned"])
        ...
        self.assertEqual(np.int16(65535), u_lat.data[5, 109])
        ...
        self.assertEqual(np.int16(65535), u_lon.data[6, 110])
        ...
        self.assertEqual(DefaultData.get_default_fill_value(np.float32), u_a1.data)
